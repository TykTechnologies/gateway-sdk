...
**CORS** | Pointer to [**APIDefinitionCORSModel**](APIDefinitionCORSModel.md) |  | [optional] 
**Active** | Pointer to **bool** |  | [optional] 
**AllowedIps** | Pointer to **[]string** |  | [optional] 
**ApiId** | Pointer to **string** |  | [optional] 
**Auth** | Pointer to [**AuthModel**](AuthModel.md) |  | [optional] 
**AuthProvider** | Pointer to [**AuthProviderMetaModel**](AuthProviderMetaModel.md) |  | [optional] 
**BaseIdentityProvidedBy** | Pointer to **string** |  | [optional] 
**BasicAuth** | Pointer to [**APIDefinitionBasicAuthModel**](APIDefinitionBasicAuthModel.md) |  | [optional] 
**BlacklistedIps** | Pointer to **[]string** |  | [optional] 
**CacheOptions** | Pointer to [**CacheOptionsModel**](CacheOptionsModel.md) |  | [optional] 
...
**CustomMiddleware** | Pointer to [**MiddlewareSectionModel**](MiddlewareSectionModel.md) |  | [optional] 
**CustomMiddlewareBundle** | Pointer to **string** |  | [optional] 
**Definition** | Pointer to [**APIDefinitionDefinitionModel**](APIDefinitionDefinitionModel.md) |  | [optional] 
...
**EventHandlers** | Pointer to [**EventHandlerMetaConfigModel**](EventHandlerMetaConfigModel.md) |  | [optional] 
**ExpireAnalyticsAfter** | Pointer to **int64** |  | [optional] 
**GlobalRateLimit** | Pointer to [**GlobalRateLimitModel**](GlobalRateLimitModel.md) |  | [optional] 
...
**OauthMeta** | Pointer to [**APIDefinitionOauthMetaModel**](APIDefinitionOauthMetaModel.md) |  | [optional] 
**OpenidOptions** | Pointer to [**OpenIDOptionsModel**](OpenIDOptionsModel.md) |  | [optional] 
**OrgId** | Pointer to **string** |  | [optional] 
**PinnedPublicKeys** | Pointer to **map[string]string** |  | [optional] 
**Proxy** | Pointer to [**APIDefinitionProxyModel**](APIDefinitionProxyModel.md) |  | [optional] 
**ResponseProcessors** | Pointer to [**[]ResponseProcessorModel**](ResponseProcessorModel.md) |  | [optional] 
**SessionLifetime** | Pointer to **int64** |  | [optional] 
**SessionProvider** | Pointer to [**SessionProviderMetaModel**](SessionProviderMetaModel.md) |  | [optional] 
