...
type HotReloadAPI interface {
	...
	*/
	...
	HotReloadExecute(r ApiHotReloadRequest) (*ApiStatusMessageModelModel, *http.Response, error)
	...
	*/
	...
	//  @return ApiStatusMessageModelModel
	HotReloadGroupExecute(r ApiHotReloadGroupRequest) (*ApiStatusMessageModelModel, *http.Response, error)
}
...
func (r ApiHotReloadRequest) Execute() (*ApiStatusMessageModelModel, *http.Response, error) {
...
//  @return ApiStatusMessageModelModel
func (a *HotReloadAPIService) HotReloadExecute(r ApiHotReloadRequest) (*ApiStatusMessageModelModel, *http.Response, error) {
	var (
...
func (r ApiHotReloadGroupRequest) Execute() (*ApiStatusMessageModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return ApiStatusMessageModelModel
func (a *HotReloadAPIService) HotReloadGroupExecute(r ApiHotReloadGroupRequest) (*ApiStatusMessageModelModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
