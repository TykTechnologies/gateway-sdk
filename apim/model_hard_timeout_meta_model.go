...
// HardTimeoutMetaModel struct for HardTimeoutMetaModel
type HardTimeoutMetaModel struct {
...
func (o HardTimeoutMetaModel) MarshalJSON() ([]byte, error) {
...
type NullableHardTimeoutMetaModel struct {
	value *HardTimeoutMetaModel
	isSet bool
}

func (v NullableHardTimeoutMetaModel) Get() *HardTimeoutMetaModel {
	return v.value
}

func (v *NullableHardTimeoutMetaModel) Set(val *HardTimeoutMetaModel) {
	v.value = val
	v.isSet = true
}

func (v NullableHardTimeoutMetaModel) IsSet() bool {
	return v.isSet
}

func (v *NullableHardTimeoutMetaModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHardTimeoutMetaModel(val *HardTimeoutMetaModel) *NullableHardTimeoutMetaModel {
	return &NullableHardTimeoutMetaModel{value: val, isSet: true}
}

func (v NullableHardTimeoutMetaModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHardTimeoutMetaModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
