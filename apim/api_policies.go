...
type PoliciesAPI interface {
	...
	*/
	...
	AddPolicyExecute(r ApiAddPolicyRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error)
	...
	*/
	...
	//  @return ApiModifyKeySuccessModelModel
	DeletePolicyExecute(r ApiDeletePolicyRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error)
	...
	*/
	...
	//  @return PolicyModelModel
	GetPolicyExecute(r ApiGetPolicyRequest) (*PolicyModelModel, *http.Response, error)
	...
	*/
	...
	//  @return []PolicyModelModel
	ListPoliciesExecute(r ApiListPoliciesRequest) ([]PolicyModelModel, *http.Response, error)
	...
	*/
	...
	//  @return ApiModifyKeySuccessModelModel
	UpdatePolicyExecute(r ApiUpdatePolicyRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error)
}
...
func (r ApiAddPolicyRequest) PolicyModel(policyModel PolicyModel) ApiAddPolicyRequest {
	r.policyModel = &policyModel
	return r
}

func (r ApiAddPolicyRequest) Execute() (*ApiModifyKeySuccessModelModel, *http.Response, error) {
...
//  @return ApiModifyKeySuccessModelModel
func (a *PoliciesAPIService) AddPolicyExecute(r ApiAddPolicyRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error) {
	var (
	...
	if r.policyModel == nil {
		return localVarReturnValue, nil, reportError("policyModel is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.policyModel
	if r.ctx != nil {
...
func (r ApiDeletePolicyRequest) Execute() (*ApiModifyKeySuccessModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return ApiModifyKeySuccessModelModel
func (a *PoliciesAPIService) DeletePolicyExecute(r ApiDeletePolicyRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error) {
	var (
...
func (r ApiGetPolicyRequest) Execute() (*PolicyModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return PolicyModelModel
func (a *PoliciesAPIService) GetPolicyExecute(r ApiGetPolicyRequest) (*PolicyModelModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PolicyModelModel
	)
...
func (r ApiListPoliciesRequest) Execute() ([]PolicyModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return []PolicyModelModel
func (a *PoliciesAPIService) ListPoliciesExecute(r ApiListPoliciesRequest) ([]PolicyModelModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiUpdatePolicyRequest) PolicyModel(policyModel PolicyModel) ApiUpdatePolicyRequest {
	r.policyModel = &policyModel
	return r
}

func (r ApiUpdatePolicyRequest) Execute() (*ApiModifyKeySuccessModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return ApiModifyKeySuccessModelModel
func (a *PoliciesAPIService) UpdatePolicyExecute(r ApiUpdatePolicyRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error) {
	var (
