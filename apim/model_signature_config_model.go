...
// SignatureConfigModel struct for SignatureConfigModel
type SignatureConfigModel struct {
...
func (o SignatureConfigModel) MarshalJSON() ([]byte, error) {
...
type NullableSignatureConfigModel struct {
	value *SignatureConfigModel
	isSet bool
}

func (v NullableSignatureConfigModel) Get() *SignatureConfigModel {
	return v.value
}

func (v *NullableSignatureConfigModel) Set(val *SignatureConfigModel) {
	v.value = val
	v.isSet = true
}

func (v NullableSignatureConfigModel) IsSet() bool {
	return v.isSet
}

func (v *NullableSignatureConfigModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSignatureConfigModel(val *SignatureConfigModel) *NullableSignatureConfigModel {
	return &NullableSignatureConfigModel{value: val, isSet: true}
}

func (v NullableSignatureConfigModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSignatureConfigModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
