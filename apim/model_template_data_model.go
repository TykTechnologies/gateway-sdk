...
// TemplateDataModel struct for TemplateDataModel
...
func (o TemplateDataModel) MarshalJSON() ([]byte, error) {
...
type NullableTemplateDataModel struct {
	value *TemplateDataModel
	isSet bool
}

func (v NullableTemplateDataModel) Get() *TemplateDataModel {
	return v.value
}

func (v *NullableTemplateDataModel) Set(val *TemplateDataModel) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateDataModel) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateDataModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateDataModel(val *TemplateDataModel) *NullableTemplateDataModel {
	return &NullableTemplateDataModel{value: val, isSet: true}
}

func (v NullableTemplateDataModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateDataModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
