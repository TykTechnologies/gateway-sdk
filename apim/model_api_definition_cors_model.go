...
// APIDefinitionCORSModel struct for APIDefinitionCORSModel
type APIDefinitionCORSModel struct {
...
func (o APIDefinitionCORSModel) MarshalJSON() ([]byte, error) {
...
type NullableAPIDefinitionCORSModel struct {
	value *APIDefinitionCORSModel
	isSet bool
}

func (v NullableAPIDefinitionCORSModel) Get() *APIDefinitionCORSModel {
	return v.value
}

func (v *NullableAPIDefinitionCORSModel) Set(val *APIDefinitionCORSModel) {
	v.value = val
	v.isSet = true
}

func (v NullableAPIDefinitionCORSModel) IsSet() bool {
	return v.isSet
}

func (v *NullableAPIDefinitionCORSModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAPIDefinitionCORSModel(val *APIDefinitionCORSModel) *NullableAPIDefinitionCORSModel {
	return &NullableAPIDefinitionCORSModel{value: val, isSet: true}
}

func (v NullableAPIDefinitionCORSModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAPIDefinitionCORSModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
