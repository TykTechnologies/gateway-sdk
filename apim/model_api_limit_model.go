...
// APILimitModel APILimit stores quota and rate limit on ACL level (per API)
type APILimitModel struct {
...
func (o APILimitModel) MarshalJSON() ([]byte, error) {
...
type NullableAPILimitModel struct {
	value *APILimitModel
	isSet bool
}

func (v NullableAPILimitModel) Get() *APILimitModel {
	return v.value
}

func (v *NullableAPILimitModel) Set(val *APILimitModel) {
	v.value = val
	v.isSet = true
}

func (v NullableAPILimitModel) IsSet() bool {
	return v.isSet
}

func (v *NullableAPILimitModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAPILimitModel(val *APILimitModel) *NullableAPILimitModel {
	return &NullableAPILimitModel{value: val, isSet: true}
}

func (v NullableAPILimitModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAPILimitModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
