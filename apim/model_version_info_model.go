...
// VersionInfoModel struct for VersionInfoModel
type VersionInfoModel struct {
	Paths *VersionInfoPathsModelModel `json:"paths,omitempty"`
	Expires *string `json:"expires,omitempty"`
	ExtendedPaths *ExtendedPathsSetModelModel `json:"extended_paths,omitempty"`
...
func (o *VersionInfoModel) GetPaths() VersionInfoPathsModelModel {
	if o == nil || o.Paths == nil {
		var ret VersionInfoPathsModelModel
		return ret
	}
	return *o.Paths
}
...
// SetPaths gets a reference to the given VersionInfoPathsModelModel and assigns it to the Paths field.
...
func (o *VersionInfoModel) GetExtendedPaths() ExtendedPathsSetModelModel {
	if o == nil || o.ExtendedPaths == nil {
		var ret ExtendedPathsSetModelModel
		return ret
	}
...
// SetExtendedPaths gets a reference to the given ExtendedPathsSetModelModel and assigns it to the ExtendedPaths field.
...
func (o VersionInfoModel) MarshalJSON() ([]byte, error) {
...
type NullableVersionInfoModel struct {
	value *VersionInfoModel
	isSet bool
}

func (v NullableVersionInfoModel) Get() *VersionInfoModel {
	return v.value
}

func (v *NullableVersionInfoModel) Set(val *VersionInfoModel) {
	v.value = val
	v.isSet = true
}

func (v NullableVersionInfoModel) IsSet() bool {
	return v.isSet
}

func (v *NullableVersionInfoModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVersionInfoModel(val *VersionInfoModel) *NullableVersionInfoModel {
	return &NullableVersionInfoModel{value: val, isSet: true}
}

func (v NullableVersionInfoModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVersionInfoModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
