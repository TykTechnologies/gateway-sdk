...
type CertsAPI interface {
	...
	*/
	...
	//  @return APICertificateStatusMessageModelModel
	AddCertExecute(r ApiAddCertRequest) (*APICertificateStatusMessageModelModel, *http.Response, error)
	...
	*/
	...
	DeleteCertsExecute(r ApiDeleteCertsRequest) (*ApiStatusMessageModelModel, *http.Response, error)
	...
	*/
	...
	//  @return ListCerts200ResponseModelModel
	ListCertsExecute(r ApiListCertsRequest) (*ListCerts200ResponseModelModel, *http.Response, error)
}
...
func (r ApiAddCertRequest) Execute() (*APICertificateStatusMessageModelModel, *http.Response, error) {
...
//  @return APICertificateStatusMessageModelModel
func (a *CertsAPIService) AddCertExecute(r ApiAddCertRequest) (*APICertificateStatusMessageModelModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *APICertificateStatusMessageModelModel
	)
...
func (r ApiDeleteCertsRequest) Execute() (*ApiStatusMessageModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return ApiStatusMessageModelModel
func (a *CertsAPIService) DeleteCertsExecute(r ApiDeleteCertsRequest) (*ApiStatusMessageModelModel, *http.Response, error) {
	var (
...
func (r ApiListCertsRequest) Execute() (*ListCerts200ResponseModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return ListCerts200ResponseModelModel
func (a *CertsAPIService) ListCertsExecute(r ApiListCertsRequest) (*ListCerts200ResponseModelModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListCerts200ResponseModelModel
	)
