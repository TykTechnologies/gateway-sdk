...
type ListCerts200Response struct {
	...
	ArrayOfCertificateMeta *[]CertificateMeta
}
...
// []CertificateMetaAsListCerts200Response is a convenience function that returns []CertificateMeta wrapped in ListCerts200Response
func ArrayOfCertificateMetaAsListCerts200Response(v *[]CertificateMeta) ListCerts200Response {
	return ListCerts200Response{
		ArrayOfCertificateMeta: v,
	}
}
...
func (dst *ListCerts200Response) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into ArrayOfCertificateMeta
	err = newStrictDecoder(data).Decode(&dst.ArrayOfCertificateMeta)
	if err == nil {
		jsonArrayOfCertificateMeta, _ := json.Marshal(dst.ArrayOfCertificateMeta)
		if string(jsonArrayOfCertificateMeta) == "{}" { // empty struct
			dst.ArrayOfCertificateMeta = nil
		} else {
			match++
		}
	} else {
...
func (src ListCerts200Response) MarshalJSON() ([]byte, error) {
	...
	if src.ArrayOfCertificateMeta != nil {
		return json.Marshal(&src.ArrayOfCertificateMeta)
	}
...
func (obj *ListCerts200Response) GetActualInstance() (interface{}) {
	...
	if obj.ArrayOfCertificateMeta != nil {
		return obj.ArrayOfCertificateMeta
	}
