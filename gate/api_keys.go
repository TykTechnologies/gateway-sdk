...
API keys without access_rights data will be written to all APIs on the system (this also means that they will be created across all SessionHandlers and StorageHandlers, it is recommended to always embed access_rights data in a key to ensure that only targeted APIs and their back-ends are written to.
	...
	*/
	...
	AddKeyExecute(r ApiAddKeyRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error)
...
```
	...
	*/
	...
	//  @return ApiModifyKeySuccessModelModel
	CreateCustomKeyExecute(r ApiCreateCustomKeyRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error)
	...
	*/
	...
	DeleteKeyExecute(r ApiDeleteKeyRequest) (*ApiStatusMessageModelModel, *http.Response, error)
	...
	*/
	...
	GetKeyExecute(r ApiGetKeyRequest) (*SessionStateModelModel, *http.Response, error)
	...
	*/
	...
	//  @return ApiAllKeysModelModel
	ListKeysExecute(r ApiListKeysRequest) (*ApiAllKeysModelModel, *http.Response, error)
	...
	*/
	...
	//  @return ApiModifyKeySuccessModelModel
	UpdateKeyExecute(r ApiUpdateKeyRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error)
}
...
func (r ApiAddKeyRequest) SessionStateModel(sessionStateModel SessionStateModel) ApiAddKeyRequest {
	r.sessionStateModel = &sessionStateModel
	return r
}

func (r ApiAddKeyRequest) Execute() (*ApiModifyKeySuccessModelModel, *http.Response, error) {
...
//  @return ApiModifyKeySuccessModelModel
func (a *KeysAPIService) AddKeyExecute(r ApiAddKeyRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error) {
	var (
...
func (r ApiCreateCustomKeyRequest) SessionStateModel(sessionStateModel SessionStateModel) ApiCreateCustomKeyRequest {
	r.sessionStateModel = &sessionStateModel
	return r
}

func (r ApiCreateCustomKeyRequest) Execute() (*ApiModifyKeySuccessModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return ApiModifyKeySuccessModelModel
func (a *KeysAPIService) CreateCustomKeyExecute(r ApiCreateCustomKeyRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiDeleteKeyRequest) Execute() (*ApiStatusMessageModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return ApiStatusMessageModelModel
func (a *KeysAPIService) DeleteKeyExecute(r ApiDeleteKeyRequest) (*ApiStatusMessageModelModel, *http.Response, error) {
	var (
...
func (r ApiGetKeyRequest) Execute() (*SessionStateModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return SessionStateModelModel
func (a *KeysAPIService) GetKeyExecute(r ApiGetKeyRequest) (*SessionStateModelModel, *http.Response, error) {
	var (
...
func (r ApiListKeysRequest) Execute() (*ApiAllKeysModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return ApiAllKeysModelModel
func (a *KeysAPIService) ListKeysExecute(r ApiListKeysRequest) (*ApiAllKeysModelModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApiAllKeysModelModel
	)
...
func (r ApiUpdateKeyRequest) SessionStateModel(sessionStateModel SessionStateModel) ApiUpdateKeyRequest {
	r.sessionStateModel = &sessionStateModel
	return r
}

func (r ApiUpdateKeyRequest) Execute() (*ApiModifyKeySuccessModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return ApiModifyKeySuccessModelModel
func (a *KeysAPIService) UpdateKeyExecute(r ApiUpdateKeyRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error) {
	var (
