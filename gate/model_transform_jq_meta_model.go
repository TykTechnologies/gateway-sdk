...
// TransformJQMetaModel struct for TransformJQMetaModel
type TransformJQMetaModel struct {
...
func (o TransformJQMetaModel) MarshalJSON() ([]byte, error) {
...
type NullableTransformJQMetaModel struct {
	value *TransformJQMetaModel
	isSet bool
}

func (v NullableTransformJQMetaModel) Get() *TransformJQMetaModel {
	return v.value
}

func (v *NullableTransformJQMetaModel) Set(val *TransformJQMetaModel) {
	v.value = val
	v.isSet = true
}

func (v NullableTransformJQMetaModel) IsSet() bool {
	return v.isSet
}

func (v *NullableTransformJQMetaModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransformJQMetaModel(val *TransformJQMetaModel) *NullableTransformJQMetaModel {
	return &NullableTransformJQMetaModel{value: val, isSet: true}
}

func (v NullableTransformJQMetaModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransformJQMetaModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
