...
type APIDefinitionModel struct {
	...
	CORS *APIDefinitionCORSModelModel `json:"CORS,omitempty"`
	Active *bool `json:"active,omitempty"`
	AllowedIps []string `json:"allowed_ips,omitempty"`
	ApiId *string `json:"api_id,omitempty"`
	Auth *AuthModelModel `json:"auth,omitempty"`
	AuthProvider *AuthProviderMetaModelModel `json:"auth_provider,omitempty"`
	BaseIdentityProvidedBy *string `json:"base_identity_provided_by,omitempty"`
	BasicAuth *APIDefinitionBasicAuthModelModel `json:"basic_auth,omitempty"`
	BlacklistedIps []string `json:"blacklisted_ips,omitempty"`
	CacheOptions *CacheOptionsModelModel `json:"cache_options,omitempty"`
	...
	CustomMiddleware *MiddlewareSectionModelModel `json:"custom_middleware,omitempty"`
	CustomMiddlewareBundle *string `json:"custom_middleware_bundle,omitempty"`
	Definition *APIDefinitionDefinitionModelModel `json:"definition,omitempty"`
	...
	EventHandlers *EventHandlerMetaConfigModelModel `json:"event_handlers,omitempty"`
	ExpireAnalyticsAfter *int64 `json:"expire_analytics_after,omitempty"`
	GlobalRateLimit *GlobalRateLimitModelModel `json:"global_rate_limit,omitempty"`
	...
	OauthMeta *APIDefinitionOauthMetaModelModel `json:"oauth_meta,omitempty"`
	OpenidOptions *OpenIDOptionsModelModel `json:"openid_options,omitempty"`
	OrgId *string `json:"org_id,omitempty"`
	PinnedPublicKeys *map[string]string `json:"pinned_public_keys,omitempty"`
	Proxy *APIDefinitionProxyModelModel `json:"proxy,omitempty"`
	ResponseProcessors []ResponseProcessorModelModel `json:"response_processors,omitempty"`
	SessionLifetime *int64 `json:"session_lifetime,omitempty"`
	SessionProvider *SessionProviderMetaModelModel `json:"session_provider,omitempty"`
...
func (o *APIDefinitionModel) GetCORS() APIDefinitionCORSModelModel {
	if o == nil || o.CORS == nil {
		var ret APIDefinitionCORSModelModel
		return ret
	}
	return *o.CORS
}
...
// SetCORS gets a reference to the given APIDefinitionCORSModelModel and assigns it to the CORS field.
...
// SetAuth gets a reference to the given AuthModelModel and assigns it to the Auth field.
...
func (o *APIDefinitionModel) GetAuthProvider() AuthProviderMetaModelModel {
	if o == nil || o.AuthProvider == nil {
		var ret AuthProviderMetaModelModel
		return ret
	}
...
// SetAuthProvider gets a reference to the given AuthProviderMetaModelModel and assigns it to the AuthProvider field.
...
func (o *APIDefinitionModel) GetBasicAuth() APIDefinitionBasicAuthModelModel {
	if o == nil || o.BasicAuth == nil {
		var ret APIDefinitionBasicAuthModelModel
		return ret
	}
	return *o.BasicAuth
}
...
// SetBasicAuth gets a reference to the given APIDefinitionBasicAuthModelModel and assigns it to the BasicAuth field.
...
func (o *APIDefinitionModel) GetCacheOptions() CacheOptionsModelModel {
	if o == nil || o.CacheOptions == nil {
		var ret CacheOptionsModelModel
		return ret
	}
...
// SetCacheOptions gets a reference to the given CacheOptionsModelModel and assigns it to the CacheOptions field.
...
func (o *APIDefinitionModel) GetCustomMiddleware() MiddlewareSectionModelModel {
	if o == nil || o.CustomMiddleware == nil {
		var ret MiddlewareSectionModelModel
		return ret
	}
...
// SetCustomMiddleware gets a reference to the given MiddlewareSectionModelModel and assigns it to the CustomMiddleware field.
...
func (o *APIDefinitionModel) GetDefinition() APIDefinitionDefinitionModelModel {
	if o == nil || o.Definition == nil {
		var ret APIDefinitionDefinitionModelModel
		return ret
	}
	return *o.Definition
}
...
// SetDefinition gets a reference to the given APIDefinitionDefinitionModelModel and assigns it to the Definition field.
...
func (o *APIDefinitionModel) GetEventHandlers() EventHandlerMetaConfigModelModel {
	if o == nil || o.EventHandlers == nil {
		var ret EventHandlerMetaConfigModelModel
		return ret
	}
...
// SetEventHandlers gets a reference to the given EventHandlerMetaConfigModelModel and assigns it to the EventHandlers field.
...
func (o *APIDefinitionModel) GetGlobalRateLimit() GlobalRateLimitModelModel {
	if o == nil || o.GlobalRateLimit == nil {
		var ret GlobalRateLimitModelModel
		return ret
	}
...
// SetGlobalRateLimit gets a reference to the given GlobalRateLimitModelModel and assigns it to the GlobalRateLimit field.
...
func (o *APIDefinitionModel) GetOauthMeta() APIDefinitionOauthMetaModelModel {
	if o == nil || o.OauthMeta == nil {
		var ret APIDefinitionOauthMetaModelModel
		return ret
	}
	return *o.OauthMeta
}
...
// SetOauthMeta gets a reference to the given APIDefinitionOauthMetaModelModel and assigns it to the OauthMeta field.
...
func (o *APIDefinitionModel) GetOpenidOptions() OpenIDOptionsModelModel {
	if o == nil || o.OpenidOptions == nil {
		var ret OpenIDOptionsModelModel
		return ret
	}
...
// SetOpenidOptions gets a reference to the given OpenIDOptionsModelModel and assigns it to the OpenidOptions field.
...
func (o *APIDefinitionModel) GetProxy() APIDefinitionProxyModelModel {
	if o == nil || o.Proxy == nil {
		var ret APIDefinitionProxyModelModel
		return ret
	}
	return *o.Proxy
}
...
// SetProxy gets a reference to the given APIDefinitionProxyModelModel and assigns it to the Proxy field.
...
func (o *APIDefinitionModel) GetResponseProcessors() []ResponseProcessorModelModel {
	if o == nil || o.ResponseProcessors == nil {
		var ret []ResponseProcessorModelModel
		return ret
	}
...
// SetResponseProcessors gets a reference to the given []ResponseProcessorModelModel and assigns it to the ResponseProcessors field.
...
func (o *APIDefinitionModel) GetSessionProvider() SessionProviderMetaModelModel {
	if o == nil || o.SessionProvider == nil {
		var ret SessionProviderMetaModelModel
		return ret
	}
...
// SetSessionProvider gets a reference to the given SessionProviderMetaModelModel and assigns it to the SessionProvider field.
