...
// RoutingTriggerModel struct for RoutingTriggerModel
type RoutingTriggerModel struct {
	On *string `json:"on,omitempty"`
	Options *RoutingTriggerOptionsModelModel `json:"options,omitempty"`
...
func (o *RoutingTriggerModel) GetOptions() RoutingTriggerOptionsModelModel {
	if o == nil || o.Options == nil {
		var ret RoutingTriggerOptionsModelModel
		return ret
	}
	return *o.Options
}
...
// SetOptions gets a reference to the given RoutingTriggerOptionsModelModel and assigns it to the Options field.
...
func (o RoutingTriggerModel) MarshalJSON() ([]byte, error) {
...
type NullableRoutingTriggerModel struct {
	value *RoutingTriggerModel
	isSet bool
}

func (v NullableRoutingTriggerModel) Get() *RoutingTriggerModel {
	return v.value
}

func (v *NullableRoutingTriggerModel) Set(val *RoutingTriggerModel) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingTriggerModel) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingTriggerModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingTriggerModel(val *RoutingTriggerModel) *NullableRoutingTriggerModel {
	return &NullableRoutingTriggerModel{value: val, isSet: true}
}

func (v NullableRoutingTriggerModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingTriggerModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
