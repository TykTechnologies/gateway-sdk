...
type OASAPIsAPI interface {
 ...
 A single Tyk node can have its API Definitions queried, deleted and updated remotely. This functionality enables you to remotely update your Tyk definitions without having to manage the files manually.
	...
	*/
	...
	CreateApiOASExecute(r ApiCreateApiOASRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error)
	...
	*/
	...
	DeleteOASApiExecute(r ApiDeleteOASApiRequest) (*ApiStatusMessageModelModel, *http.Response, error)
	...
	*/
	...
	//  @return OASSchemaResponseModelModel
	DownloadApiOASPublicExecute(r ApiDownloadApiOASPublicRequest) (*OASSchemaResponseModelModel, *http.Response, error)
	...
	*/
	...
	//  @return []OASSchemaResponseModelModel
	DownloadApisOASPublicExecute(r ApiDownloadApisOASPublicRequest) ([]OASSchemaResponseModelModel, *http.Response, error)
...
For use with an existing OAS API that you want to expose via your Tyk Gateway. (New)
	...
	*/
	...
	//  @return ApiModifyKeySuccessModelModel
	ImportOASExecute(r ApiImportOASRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error)
...
Only if used without the Tyk Dashboard
	...
	*/
	...
	//  @return OASSchemaResponseModelModel
	ListApiOASExecute(r ApiListApiOASRequest) (*OASSchemaResponseModelModel, *http.Response, error)
	...
	*/
	...
	//  @return []OASSchemaResponseModelModel
	ListApisOASExecute(r ApiListApisOASRequest) ([]OASSchemaResponseModelModel, *http.Response, error)
...
This endpoint allows you to configure tyk OAS extension based on query params provided(similar to import)
	...
	*/
	...
	//  @return ApiModifyKeySuccessModelModel
	PatchApiOASExecute(r ApiPatchApiOASRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error)
...
Updating will completely replace the file descriptor and will not change an API Definition that has already been loaded, the hot-reload endpoint will need to be called to push the new definition to live.
	...
	*/
	...
	//  @return ApiModifyKeySuccessModelModel
	UpdateApiOASExecute(r ApiUpdateApiOASRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error)
}
...
func (r ApiCreateApiOASRequest) SchemaModel(schemaModel SchemaModel) ApiCreateApiOASRequest {
	r.schemaModel = &schemaModel
	return r
}

func (r ApiCreateApiOASRequest) Execute() (*ApiModifyKeySuccessModelModel, *http.Response, error) {
...
//  @return ApiModifyKeySuccessModelModel
func (a *OASAPIsAPIService) CreateApiOASExecute(r ApiCreateApiOASRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.schemaModel
	if r.ctx != nil {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v ApiStatusMessageModelModel
...
func (r ApiDeleteOASApiRequest) Execute() (*ApiStatusMessageModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return ApiStatusMessageModelModel
func (a *OASAPIsAPIService) DeleteOASApiExecute(r ApiDeleteOASApiRequest) (*ApiStatusMessageModelModel, *http.Response, error) {
	var (
...
func (r ApiDownloadApiOASPublicRequest) Execute() (*OASSchemaResponseModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return OASSchemaResponseModelModel
func (a *OASAPIsAPIService) DownloadApiOASPublicExecute(r ApiDownloadApiOASPublicRequest) (*OASSchemaResponseModelModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *OASSchemaResponseModelModel
	)
...
func (r ApiDownloadApisOASPublicRequest) Execute() ([]OASSchemaResponseModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return []OASSchemaResponseModelModel
func (a *OASAPIsAPIService) DownloadApisOASPublicExecute(r ApiDownloadApisOASPublicRequest) ([]OASSchemaResponseModelModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiImportOASRequest struct {
	...
	customDomain *string
	apiID *string
	allowList *BooleanQueryParamModel
	validateRequest *BooleanQueryParamModel
	authentication *BooleanQueryParamModel
	schemaModel *SchemaModel
}
...
func (r ApiImportOASRequest) AllowList(allowList BooleanQueryParamModel) ApiImportOASRequest {
...
func (r ApiImportOASRequest) ValidateRequest(validateRequest BooleanQueryParamModel) ApiImportOASRequest {
	r.validateRequest = &validateRequest
	return r
}

// Enable or disable authentication in your Tyk Gateway as per your OAS document.
func (r ApiImportOASRequest) Authentication(authentication BooleanQueryParamModel) ApiImportOASRequest {
	r.authentication = &authentication
	return r
}

func (r ApiImportOASRequest) SchemaModel(schemaModel SchemaModel) ApiImportOASRequest {
	r.schemaModel = &schemaModel
	return r
}

func (r ApiImportOASRequest) Execute() (*ApiModifyKeySuccessModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return ApiModifyKeySuccessModelModel
func (a *OASAPIsAPIService) ImportOASExecute(r ApiImportOASRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.upstreamURL != nil {
		localVarQueryParams.Add("upstreamURL", parameterToString(*r.upstreamURL, ""))
	}
	if r.listenPath != nil {
		localVarQueryParams.Add("listenPath", parameterToString(*r.listenPath, ""))
	}
	if r.customDomain != nil {
		localVarQueryParams.Add("customDomain", parameterToString(*r.customDomain, ""))
	}
	if r.apiID != nil {
		localVarQueryParams.Add("apiID", parameterToString(*r.apiID, ""))
	}
	if r.allowList != nil {
		localVarQueryParams.Add("allowList", parameterToString(*r.allowList, ""))
	}
	if r.validateRequest != nil {
		localVarQueryParams.Add("validateRequest", parameterToString(*r.validateRequest, ""))
	}
	if r.authentication != nil {
		localVarQueryParams.Add("authentication", parameterToString(*r.authentication, ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{"application/json"}
...
func (r ApiListApiOASRequest) Execute() (*OASSchemaResponseModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return OASSchemaResponseModelModel
func (a *OASAPIsAPIService) ListApiOASExecute(r ApiListApiOASRequest) (*OASSchemaResponseModelModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiListApisOASRequest) Execute() ([]OASSchemaResponseModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return []OASSchemaResponseModelModel
func (a *OASAPIsAPIService) ListApisOASExecute(r ApiListApisOASRequest) ([]OASSchemaResponseModelModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Enable validateRequest middleware for all endpoints having a request body with media type application/json
func (r ApiPatchApiOASRequest) ValidateRequest(validateRequest BooleanQueryParamModel) ApiPatchApiOASRequest {
	r.validateRequest = &validateRequest
	return r
}

// Enable allowList middleware for all endpoints
func (r ApiPatchApiOASRequest) AllowList(allowList BooleanQueryParamModel) ApiPatchApiOASRequest {
	r.allowList = &allowList
	return r
}

// Enable or disable authentication in your Tyk Gateway as per your OAS document.
func (r ApiPatchApiOASRequest) Authentication(authentication BooleanQueryParamModel) ApiPatchApiOASRequest {
	r.authentication = &authentication
	return r
}

func (r ApiPatchApiOASRequest) SchemaModel(schemaModel SchemaModel) ApiPatchApiOASRequest {
	r.schemaModel = &schemaModel
	return r
}

func (r ApiPatchApiOASRequest) Execute() (*ApiModifyKeySuccessModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return ApiModifyKeySuccessModelModel
func (a *OASAPIsAPIService) PatchApiOASExecute(r ApiPatchApiOASRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error) {
	var (
...
func (r ApiUpdateApiOASRequest) SchemaModel(schemaModel SchemaModel) ApiUpdateApiOASRequest {
	r.schemaModel = &schemaModel
	return r
}

func (r ApiUpdateApiOASRequest) Execute() (*ApiModifyKeySuccessModelModel, *http.Response, error) {
...
// Execute executes the request
//  @return ApiModifyKeySuccessModelModel
func (a *OASAPIsAPIService) UpdateApiOASExecute(r ApiUpdateApiOASRequest) (*ApiModifyKeySuccessModelModel, *http.Response, error) {
	var (
