...
type BatchRequestsAPI interface {
	...
	*/
	...
	BatchExecute(r ApiBatchRequest) (*ApiStatusMessage, *http.Response, error)
}
...
func (r ApiBatchRequest) Execute() (*ApiStatusMessage, *http.Response, error) {
...
//  @return ApiStatusMessage
func (a *BatchRequestsAPIService) BatchExecute(r ApiBatchRequest) (*ApiStatusMessage, *http.Response, error) {
	var (
