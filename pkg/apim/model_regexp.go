...
// checks if the Regexp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Regexp{}
...
func (o Regexp) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.FromCache) {
