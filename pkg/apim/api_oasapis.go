...
Only if used without the Tyk Dashboard
	...
	*/
	...
	/*
	ListOASApiVersions Method for ListOASApiVersions
	...
	*/
	...
	ListOASApiVersionsExecute(r ApiListOASApiVersionsRequest) (*ListApiVersions200Response, *http.Response, error)
...
type ApiImportOASRequest struct {
	...
	mockResponse *BooleanQueryParam
...
func (r ApiImportOASRequest) MockResponse(mockResponse BooleanQueryParam) ApiImportOASRequest {
...
func (r ApiListOASApiVersionsRequest) Execute() (*ListApiVersions200Response, *http.Response, error) {
...
// Execute executes the request
//  @return ListApiVersions200Response
func (a *OASAPIsAPIService) ListOASApiVersionsExecute(r ApiListOASApiVersionsRequest) (*ListApiVersions200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Enable mockResponse middleware for all endpoints having responses configured.
func (r ApiPatchApiOASRequest) MockResponse(mockResponse BooleanQueryParam) ApiPatchApiOASRequest {
	r.mockResponse = &mockResponse
	return r
}
