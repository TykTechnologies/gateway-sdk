...
type OrganisationQuotasAPI interface {
	...
	*/
	...
	DeleteOrgKeyExecute(r ApiDeleteOrgKeyRequest) (*ApiStatusMessage, *http.Response, error)
	...
	*/
	...
	//  @return ListOrgKeys200Response
	ListOrgKeysExecute(r ApiListOrgKeysRequest) (*ListOrgKeys200Response, *http.Response, error)
...
func (r ApiListOrgKeysRequest) Execute() (*ListOrgKeys200Response, *http.Response, error) {
...
// Execute executes the request
//  @return ListOrgKeys200Response
func (a *OrganisationQuotasAPIService) ListOrgKeysExecute(r ApiListOrgKeysRequest) (*ListOrgKeys200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOrgKeys200Response
	)
