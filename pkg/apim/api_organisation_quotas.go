...
type OrganisationQuotasAPI interface {
	...
	*/
	...
	//  @return GetOrgKey200Response
	GetOrgKeyExecute(r ApiGetOrgKeyRequest) (*GetOrgKey200Response, *http.Response, error)
...
func (a *OrganisationQuotasAPIService) AddOrgKeyExecute(r ApiAddOrgKeyRequest) (*ApiModifyKeySuccess, *http.Response, error) {
	...
	if r.resetQuota != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "reset_quota", r.resetQuota, "form", "")
	}
...
// The Org ID
func (r ApiGetOrgKeyRequest) OrgID(orgID string) ApiGetOrgKeyRequest {
	r.orgID = &orgID
	return r
}

func (r ApiGetOrgKeyRequest) Execute() (*GetOrgKey200Response, *http.Response, error) {
...
//
//	@return GetOrgKey200Response
func (a *OrganisationQuotasAPIService) GetOrgKeyExecute(r ApiGetOrgKeyRequest) (*GetOrgKey200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetOrgKey200Response
	)
...
// Retrieves all keys starting with the specified filter(filter is a prefix - e.g. default* or default will return all keys starting with default  like defaultbd,defaulttwo etc).We don&#39;t use filter for hashed keys
func (r ApiListOrgKeysRequest) Filter(filter string) ApiListOrgKeysRequest {
	r.filter = &filter
	return r
}
