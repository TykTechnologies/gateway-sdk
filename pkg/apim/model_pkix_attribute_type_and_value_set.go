...
// checks if the PkixAttributeTypeAndValueSET type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PkixAttributeTypeAndValueSET{}
...
func (o PkixAttributeTypeAndValueSET) ToMap() (map[string]interface{}, error) {
