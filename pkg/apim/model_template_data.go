...
// checks if the TemplateData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateData{}
...
func (o *TemplateData) GetEnableSession() bool {
	if o == nil || IsNil(o.EnableSession) {
		var ret bool
		return ret
	}
...
func (o *TemplateData) GetTemplateSource() string {
	if o == nil || IsNil(o.TemplateSource) {
		var ret string
		return ret
	}
