...
// checks if the ListOrgKeys200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOrgKeys200Response{}
...
func (o ListOrgKeys200Response) ToMap() (map[string]interface{}, error) {
