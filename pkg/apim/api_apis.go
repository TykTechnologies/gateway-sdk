...
Only if used without the Tyk Dashboard
	...
	*/
	...
	//  @return ListApiVersions200Response
	ListApiVersionsExecute(r ApiListApiVersionsRequest) (*ListApiVersions200Response, *http.Response, error)
...
func (r ApiListApiVersionsRequest) Execute() (*ListApiVersions200Response, *http.Response, error) {
...
// Execute executes the request
//  @return ListApiVersions200Response
func (a *APIsAPIService) ListApiVersionsExecute(r ApiListApiVersionsRequest) (*ListApiVersions200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListApiVersions200Response
	)
