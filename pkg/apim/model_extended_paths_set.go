...
type ExtendedPathsSet struct {
	...
	GoPlugin                 []GoPluginMeta        `json:"go_plugin,omitempty"`
	...
	MockResponse             []MockResponseMeta    `json:"mock_response,omitempty"`
	PersistGraphql           []PersistGraphQLMeta  `json:"persist_graphql,omitempty"`
	...
	ValidateRequest          []ValidateRequestMeta `json:"validate_request,omitempty"`
...
// SetGoPlugin gets a reference to the given []GoPluginMeta and assigns it to the GoPlugin field.
...
// SetMockResponse gets a reference to the given []MockResponseMeta and assigns it to the MockResponse field.
...
// SetPersistGraphql gets a reference to the given []PersistGraphQLMeta and assigns it to the PersistGraphql field.
...
// SetRateLimit gets a reference to the given []RateLimitMeta and assigns it to the RateLimit field.
...
// SetValidateRequest gets a reference to the given []ValidateRequestMeta and assigns it to the ValidateRequest field.
