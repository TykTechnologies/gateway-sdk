...
// checks if the CertificateBasics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificateBasics{}
...
func (o CertificateBasics) ToMap() (map[string]interface{}, error) {
