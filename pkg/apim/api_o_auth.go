...
type OAuthAPI interface {
	...
	*/
	...
	/*
	GetApisForOauthApp Get Apis for Oauth app

	Get Apis for Oauth app
	...
	*/
	...
	Purge scoped lapsed OAuth token
	...
	*/
	...
	/*
	RotateOauthClient Rotate the oath client
	...
	*/
	RotateOauthClient(ctx context.Context, keyName string, apiID string) ApiRotateOauthClientRequest
	...
	*/
	UpdateOAuthClient(ctx context.Context, keyName string, apiID string) ApiUpdateOAuthClientRequest
...
RotateOauthClient Rotate the oath client
 ...
 @return ApiRotateOauthClientRequest
*/
func (a *OAuthAPIService) RotateOauthClient(ctx context.Context, keyName string, apiID string) ApiRotateOauthClientRequest {
	return ApiRotateOauthClientRequest{
		ApiService: a,
		ctx: ctx,
		keyName: keyName,
...
Allows you to update the metadata and Policy ID for an OAuth client.
 ...
 @return ApiUpdateOAuthClientRequest
*/
func (a *OAuthAPIService) UpdateOAuthClient(ctx context.Context, keyName string, apiID string) ApiUpdateOAuthClientRequest {
	return ApiUpdateOAuthClientRequest{
		ApiService: a,
		ctx: ctx,
		keyName: keyName,
