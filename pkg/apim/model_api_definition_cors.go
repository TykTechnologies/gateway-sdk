...
// checks if the APIDefinitionCORS type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &APIDefinitionCORS{}
...
func (o APIDefinitionCORS) ToMap() (map[string]interface{}, error) {
