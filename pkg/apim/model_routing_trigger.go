...
// checks if the RoutingTrigger type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingTrigger{}
...
func (o RoutingTrigger) ToMap() (map[string]interface{}, error) {
