...
// checks if the CacheOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CacheOptions{}
...
func (o CacheOptions) ToMap() (map[string]interface{}, error) {
