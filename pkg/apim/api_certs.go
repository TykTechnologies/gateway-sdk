...
Note that the certID path parameter can take a list of certIDs separated with commas (e.g /tyk/certs/certIDOne,certIDTwo).
	...
	@return ApiListCertsWithIDsRequest
*/
func (a *CertsAPIService) ListCertsWithIDs(ctx context.Context, certID string) ApiListCertsWithIDsRequest {
	return ApiListCertsWithIDsRequest{
		ApiService: a,
		ctx:        ctx,
		certID:     certID,
...
//
//	@return ListCertsWithIDs200Response
func (a *CertsAPIService) ListCertsWithIDsExecute(r ApiListCertsWithIDsRequest) (*ListCertsWithIDs200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CertsAPIService.ListCertsWithIDs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
